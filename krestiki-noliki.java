...
//с версией из урока разобрался, вроде бы получилось почти все переписать для оптимизации условий победы, но наверное можно было еще проще, с заданием про поле 5x5 и условием в 4 фишки - тоже разобрался, но костыльно наверное, с последним заданием написал только идею и чуть кода в начале, просто, чтобы не отнимать ваше время на десятки if'ов
